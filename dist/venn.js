...
// export default function() {
  d3__default['default'].venn = function() {
    ...
    function compute(data) {
      var sets = venn$1.sets(),
          setsValues,
          layout = venn$1.layoutFunction(),
          packingStragegy = venn$1.packingStragegy(),
          size = venn$1.size(),
          width = size[0],
          height = size[1],
      ...
      if (venn$1.normalize()) {
        solution = normalizeSolution(solution, venn$1.orientation());
      }

      oldCircles = circles;
      circles = scaleSolution(solution, width, height, venn$1.padding());
      ...
      packer = packingStragegy(venn$1, data);
    ...
    */
    ...
    venn$1.packingConfig = function(_) {
    ...
    venn$1.packer = function() {
      return packer;
    };

    venn$1.circles = function() {
      return circles;
    };

    venn$1.centres = function() {
      return centres;
    };
